...
var trigger = document.querySelectorAll(".faq-accordion__title");
var content = document.querySelectorAll(".faq-accordion__content");
...
trigger.forEach(function (el, index) {
